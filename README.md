...
The app ships English and Dutch, both complete at 1129 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 1129 keys, then import and register it
