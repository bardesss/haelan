...
The app ships English and Dutch, both complete at 993 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 993 keys, then import and register it
