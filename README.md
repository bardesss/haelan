...
| **M2b** Priority and merge | The per metric source priority list, `merged` rows chosen per local hour with their mix recorded, overrides applied at derivation, session overlap grouping | In review |
| **M2** Derivation and query layer | Sleep and recovery derivation, nap detection, baselines, rebuild | Not started |
