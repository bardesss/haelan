...
The app ships English and Dutch, both complete at 924 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 924 keys, then import and register it
