...
The app ships English and Dutch, both complete at 982 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 982 keys, then import and register it
