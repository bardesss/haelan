...
The app ships English and Dutch, both complete at 846 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 846 keys, then import and register it
