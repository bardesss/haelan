...
The app ships English and Dutch, both complete at 758 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 758 keys, then import and register it
