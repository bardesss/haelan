...
The app ships English and Dutch, both complete at 949 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 949 keys, then import and register it
