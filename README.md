...
The app ships English and Dutch, both complete at 773 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 773 keys, then import and register it
