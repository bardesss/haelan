...
The app ships English and Dutch, both complete at 813 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 813 keys, then import and register it
