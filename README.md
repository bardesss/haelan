...
The app ships English and Dutch, both complete at 878 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 878 keys, then import and register it
