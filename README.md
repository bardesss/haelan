...
| **M1c** Sync engine | Day aligned windows, per person jobs, sync state, token bucket, transactional writes | In review, [#19](https://github.com/bardesss/haelan/pull/19) |
