...
The app ships English and Dutch, both complete at 915 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 915 keys, then import and register it
