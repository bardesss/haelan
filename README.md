...
The app ships English and Dutch, both complete at 799 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 799 keys, then import and register it
