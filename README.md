...
The app ships English and Dutch, both complete at 880 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 880 keys, then import and register it
