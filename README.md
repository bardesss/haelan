...
The app ships English and Dutch, both complete at 805 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 805 keys, then import and register it
