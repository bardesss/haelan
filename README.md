...
The app ships English and Dutch, both complete at 1049 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 1049 keys, then import and register it
