...
| **M3** Dashboard | Eight pages, the full chart set, notes and typed events, baseline bands, override controls, i18n | In review |
...
| **M3e-2** Insight cards and the shell | Period-over-period insight cards on the Dashboard and every detail page, each withheld with its own reason when the data is too thin, the collapsible rail, the resources section, an honest Nutrition page in place of the last placeholder route, and the Dutch completeness sweep | In review |
