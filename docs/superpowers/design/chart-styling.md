...
`AXIS_FONT_SIZE` (12) from `base.ts`, which matches `--font-size-micro`, the smallest step in
the scale. Nothing in the app renders text below 12px. No chart draws a
