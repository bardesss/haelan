...
export const DATA_TYPES: readonly DataType[] = [
  ...
  listable('active-minutes', 'activeMinutes', 'interval.start_time', ACTIVITY, 'active_minutes', 'sum', 'minutes', 'minutes'),
  listable('active-zone-minutes', 'activeZoneMinutes', 'interval.start_time', ACTIVITY, 'active_zone_minutes', 'sum', 'minutes', 'minutes'),
  ...
  listable('heart-rate-variability', 'heartRateVariability', 'sample_time.physical_time', METRICS, 'hrv', 'mean', 'milliseconds', 'rmssdMilliseconds'),
  ...
  listable('daily-heart-rate-variability', 'dailyHeartRateVariability', 'date', METRICS, 'daily_hrv', 'raw', 'milliseconds', 'rmssdMilliseconds'),
  ...
  listable('nutrition-log', 'nutritionLog', 'interval.civil_start_time', NUTRITION, 'nutrition', 'sum', 'kcal', 'calories'),

  // Rejected list with "the following actions are supported: rollup, dailyRollup". Recorded so
  // the sync engine can skip them deliberately rather than discovering a 400 in production.
