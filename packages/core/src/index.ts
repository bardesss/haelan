...
export { SourceAliasStore, nameFor, namedSourcesOf, MAX_ALIAS_LENGTH } from './store/sourceAliases.ts'
export type { NamedSource } from './store/sourceAliases.ts'
export { knownAppOf, defaultNamesOf, englishDefaultName } from './api/sourceNames.ts'
export type { DefaultName, KnownAppKey } from './api/sourceNames.ts'
