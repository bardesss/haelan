 ...
 *
 * Re-measured 2026-09-25 with the per-day strip bands: 1018 files, 10 028 824 bytes (9.6 MB), 64% of
 * the ceiling below. Before them, with the dashboard's days: 1018 files, 9 921 491 bytes (9.5 MB),
