...
| **M9b** The glance page | The dashboard rebuilt on M9a, in three columns, one per question. The period insight cards leave it, since each already has a home on a page with a range, and the three views only the dashboard had move to one: the heart rate range and a day's trace to Recovery, flagged days to Notes | In review |
