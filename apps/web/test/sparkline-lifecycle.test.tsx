...
// A fresh arrow every call, which is exactly what Activity.tsx:288 and Weight.tsx:250 hand this
// component: `sparkFormat` is a parameter of a card() helper invoked inline during render, so its
// identity changes on every render even though its behaviour never does.
